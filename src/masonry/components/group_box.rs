...
pub const DEFAULT_BG: Color = Color::from_rgb8(0x2A, 0x28, 0x25);
...
/// Pick a label colour that reads cleanly on top of `bg`.
...
pub fn border_from_tint(r: u8, g: u8, b: u8) -> Color {
    Color::from_rgba8(
...
/// Group box: rounded frame with header label.
pub struct GroupBox {
